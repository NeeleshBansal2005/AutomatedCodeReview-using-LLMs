  ...
  return (
    <div className="min-h-screen bg-[#0f172a] text-slate-200 p-8 font-sans selection:bg-blue-500 selection:text-white">
      ...
      <div className="max-w-5xl mx-auto pt-10">
        ...
        {/* The Main Input Card (Glassmorphism) */}
        <div className="bg-slate-900/40 backdrop-blur-md p-10 rounded-3xl border border-slate-700/50 shadow-2xl relative overflow-hidden group">
          ...
          <div className="flex flex-col md:flex-row gap-4 relative z-10">
            ...
            <button className="bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-500 hover:to-blue-600 text-white px-10 py-5 rounded-xl font-bold text-lg transition-all transform hover:scale-[1.02] active:scale-[0.98] shadow-lg shadow-blue-900/20 flex items-center justify-center gap-3">
